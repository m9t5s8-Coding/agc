...
AG_scope<Statements>
ReturnStatement::ParseReturn(Parser& parser) {
  auto exit_statement = AG_cscope<ReturnStatement>();
  parser.advance();
  ...
  return AG_cscope<ReturnStatement>();
}

void
ReturnStatement::generate(CodeGenContext& context) {}
